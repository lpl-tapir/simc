...
#python main.py ./config/sharad_ctx.ini -n /zippy/MARS/targ/modl/MRO/CTX_DEM/GEOM_LDA/S_01061401_GEOM.TAB  -d /zippy/MARS/targ/modl/MRO/CTX_DEM/blended_r12/blended_r12-tile-0.tif 
python main.py ./config/sharad_ctx.ini -n  /zippy/MARS/orig/supl/SHARAD/PDS_v2/DATA/GEOM/S_0340XX/S_03407901_GEOM.TAB  -d /zippy/MARS/targ/modl/MRO/CTX_DEM/blended_r12/blended_r12-tile-0.tif 
python main.py ./config/sharad_ctx.ini -n  /zippy/MARS/orig/supl/SHARAD/PDS_v2/DATA/GEOM/S_0804XX/S_08040601_GEOM.TAB  -d /zippy/MARS/targ/modl/MRO/CTX_DEM/blended_r12/blended_r12-tile-0.tif 
#python main.py ./config/sharad_ctx.ini -n /zippy/MARS/orig/supl/SHARAD/PDS_v2/DATA/GEOM/S_0716XX/S_07161303_GEOM.TAB  -d /zippy/MARS/targ/modl/MRO/CTX_DEM/blended_DM_MDAP-tile-0.tif
#python main.py ./config/sharad_ctx.ini -n /zippy/MARS/targ/modl/MRO/CTX_DEM/GEOM_LDA/S_07161303_GEOM.TAB  -d /zippy/MARS/targ/modl/MRO/CTX_DEM/blended_DM_MDAP-tile-0.tif
python main.py ./config/sharad_ctx.ini -n /zippy/MARS/orig/supl/SHARAD/PDS_v2/DATA/GEOM/S_0716XX/S_07161303_GEOM.TAB  -d /zippy/MARS/targ/modl/MRO/CTX_DEM/blended_DM_MDAP-tile-0.tif
python main.py ./config/sharad_ctx.ini -n /zippy/MARS/orig/supl/SHARAD/PDS_v2/DATA/GEOM/S_0799XX/S_07994701_GEOM.TAB  -d /zippy/MARS/targ/modl/MRO/CTX_DEM/blended_DM_MDAP-tile-0.tif


#python main.py ./config/sharad_fpb.ini -n /zippy/MARS/targ/modl/MRO/CTX_DEM/GEOM_LDA/S_01255901_GEOM.TAB  -d ../dem/MOLA_SHARAD_128ppd_radius.tif 
#python main.py ./config/sharad_fpb.ini -n /zippy/MARS/targ/modl/MRO/CTX_DEM/GEOM_LDA/S_01061401_GEOM.TAB  -d ../dem/MOLA_SHARAD_128ppd_radius.tif 
#python main.py ./config/sharad_fpb.ini -n /zippy/MARS/targ/modl/MRO/CTX_DEM/GEOM_LDA/S_00894601_GEOM.TAB  -d ../dem/MOLA_SHARAD_128ppd_radius.tif 
#python main.py ./config/sharad_fpb.ini -n /zippy/MARS/targ/modl/MRO/CTX_DEM/GEOM_LDA/S_07438601_GEOM.TAB -d ../dem/MOLA_SHARAD_128ppd_radius.tif 
#python main.py ./config/sharad_fpb.ini -n /zippy/MARS/targ/modl/MRO/CTX_DEM/GEOM_LDA/S_04491202_GEOM.TAB -d ../dem/MOLA_SHARAD_128ppd_radius.tif 
#python main.py ./config/sharad_fpb.ini -n /zippy/MARS/targ/modl/MRO/CTX_DEM/GEOM_LDA/S_00600601_GEOM.TAB -d ../dem/MOLA_SHARAD_128ppd_radius.tif 
