...
python main.py ./config/sharad_fpb.ini -n /zippy/MARS/targ/modl/MRO/CTX_DEM/GEOM_LDA/S_00894601_GEOM.TAB -d /zippy/MARS/targ/modl/simc/SHARAD_MOLA_Base/MOLA_topography_base_EuripusMons.tif -o /zippy/MARS/targ/modl/simc/SHARAD_MOLA_Base
